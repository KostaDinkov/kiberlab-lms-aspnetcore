        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOn = table.Column<DateTime>(nullable: false),
                    ModifiedOn = table.Column<DateTime>(nullable: true),
                    CourseInstanceId = table.Column<string>(nullable: true),
                    UserProgressId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseStates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CourseStates_CourseInstances_CourseInstanceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Section_Lessons_LessonId",
                        column: x => x.LessonId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseStateId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SectionStates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SectionStates_CourseStates_CourseStateId",
                        column: x => x.CourseStateId,
                        principalTable: "CourseStates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SectionStates_Section_SectionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseStates_CourseInstanceId",
                table: "CourseStates",
                column: "CourseInstanceId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseStates_UserProgressId",
                table: "CourseStates",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SectionStates_CourseStateId",
                table: "SectionStates",
                column: "CourseStateId");

            migrationBuilder.CreateIndex(
                name: "IX_SectionStates_SectionId",
                table: "SectionStates",
                column: "SectionId",
                unique: true,
