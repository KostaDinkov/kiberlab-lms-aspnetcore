...
namespace KiberlabLMS.Controllers
{
    public class LessonsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Position,Description,CourseId,Id,CreatedOn,ModifiedOn")] Lesson lesson)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Name,Position,Description,CourseId,Id,CreatedOn,ModifiedOn")] Lesson lesson)
        {
            if (id != lesson.Id)
            {
                return NotFound();
